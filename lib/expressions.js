...
Expression.prototype._getPatch = function(context, value) {
  ...
  if (value instanceof templates.ParentWrapper) {
    value = value.get(context, true);
  }
...
Expression.prototype.isPathExpression = function() {
  return this instanceof PathExpression ||
    this instanceof RelativePathExpression ||
    this instanceof AliasPathExpression ||
    this instanceof AttributePathExpression;
};
